...
namespace DesignPatterns.Structural
{
    ...
    { 
        public List<List<int>> Generate(int size)
        {
            ...
            do
            {
                matrixList = GenerateValues(size);
                var splitter = new Splitter();
                var splitList = splitter.Split(matrixList);
                var verifier = new Verifier();
                isVerified = verifier.Verify(splitList);
        ...
        private List<List<int>> GenerateValues(int size)
        {
            ...
            {
                matrixList.Add(generator.Generate(size));
            }
